...
![image credit: Roman Makhmutov[^1] ](thorp.png){ width=80% }
...
![Sneaking onto an event at the stadium with a friend.](football.jpg){ width=45% }
...
- "Best way to stop yourself being *fooled* by the data is to *look* at it" --Paul Prew (Matt's ECL Mentor)
...
[^2]: \footnotesize Kennedy, P., (6 Feb 2023). Ecolab now selling products at Home Depot — the first time available at retail stores. Star Tribune. 
...
<!-- Lots of new data for data-ing as a result  -->
...
![Pulse Oximeter. image credit: Michael Heisson[^3] ](nonin.png){ width=30% }
...
- Data for Data-ing: all of it! Primarily clinical trails.
...
![image credit: Penn State Office of Physical Plant](psu_shortlidge_mall.jpg){ width=95% }
...
![Some gaps are bigger than others!](mind-the-gap2.png){ width=95% }
...
![Opening vignette from one of my favorite papers.[^5] ](w-p_1999(2).png){ width=95% }
...
-	Jill & Lonneke discussed consuming and evaluating evidence–-and implications of data-ing when engaged with forms of evidence more broadly concieved than has been typical for classical data analysis
...
<!-- >- Despite a fantastic diversity of perspectives represented at SRTL-13, I expect we will find new gaps--aspects of "data-ing" that we perhaps haven't considered. -->
...
>- Will we convene as SRTL-13 and adjourn as **D**RTL-1??
...
>"How does one speak about something that is both fish and water, means as well as end?" --Ursula Franklin[^11]
...
[^11]: Franklin, U. (1990). The Real World of Technology. CBC Enterprises: Toronto
