...
![image created with assistance of DALL·E 2 by Open AI](gap.png){ width=95% }

# Mind the gap

![image created with assistance of DALL·E 2 by Open AI](gap.png){ width=30% }
...
![Opening vignette from one of my all-time favorite papers.[^6] ](w-p_1999(2).png){ width=95% }
